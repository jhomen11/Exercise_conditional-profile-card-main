...
function render(variables = {}) {
  ...
  let name = variables.name == null ? "<h1>Lucy Boilett</h1>": variables.name;
  let lastname = variables.lastname == null ? "": variables.lastname;
  let role = variables.role == null ? "<h2>Role:</h2>": variables.role;
  let city = variables.city == null ? "<h3>City Country</h3>": variables.city;
  let country = variables.country == null ? "":variables.country;
  let position = variables.socialMediaPosition == "position-left"? "left": "right";
  let twitter = variables.twitter == null ? "": variables.twitter;
  let github = variables.github == null ? "": variables.github;
  let linkedin = variables.linkedin == null ? "https://linkedin.com/": "https://linkedin.com/in/"+variables.linkedin;
